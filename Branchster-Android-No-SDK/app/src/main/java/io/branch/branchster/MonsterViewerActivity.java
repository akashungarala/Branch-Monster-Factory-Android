...
public class MonsterViewerActivity extends FragmentActivity implements InfoFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MonsterObject latestMonsterObj = monsterPreferences.getLatestMonsterObj();
        Map<String, String> monsterMetaData = latestMonsterObj.monsterMetaData();

        // Registers a custom event "monster_view" to track the user visited the monster view page
    ...
    private void initUI() {
        ...
        if (myMonsterObject != null) {
            ...
            // Set the value of monster name text view
            ...
            // Set the value of monster description text view
            ...
            // set the image of monster image view
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (SEND_SMS == requestCode) {
            if (RESULT_OK == resultCode) {
                ...
                new BranchEvent("branch_url_shared").logEvent(getApplicationContext());
