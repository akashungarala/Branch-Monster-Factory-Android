...
public class MonsterCreatorActivity extends Activity {
    ...
    monster, or when data is received with a deep link dictionary attached. */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Registers a custom event "monster_edit" to track the user visited the monster edit page
        new BranchEvent("monster_edit").logEvent(getApplicationContext());
...
//                prefs.getBranchUniversalObjectOfLatestMonster().listOnGoogleSearch(MonsterCreatorActivity.this);
